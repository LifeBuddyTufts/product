...
function Form() {
    ...
    return (
        <>
            ...
            <form id= "myForm">
                <label class = "lab"> <input type="text" placeholder='Add class assignment or study session name here!' name="name"/></label>
                <label class = "lab"> <input type="text" placeholder='What time?' name="time"/></label>
                <label class = "lab"> <input type="text" placeholder='What would you like to focus on?' name="description"/></label> 
                <label class = "lab"> <input type="number" placeholder='How many buddies are you looking for?'name="buddies"/></label>


                <button className="submit-btn2" type="submit">Post</button>
            </form>
